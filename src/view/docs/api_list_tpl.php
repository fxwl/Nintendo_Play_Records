            ...
            if ($theme == 'fold') {
                ...
                <div class="four wide column">
                    <div class="ui vertical accordion menu">
                        ...
                        ?>
                        <div class="item"><h4><?php echo \PhalApi\T('API List'); ?>&nbsp;(<?php echo $methodTotal; ?>
                                )</h4></div>
            ...
            <div class="twelve wide stretched column">
                ...
                <div class="wide stretched column">
                    ...
                    foreach ($allApiS as $namespace => $subAllApiS) {
                        foreach ($subAllApiS as $key => $item) {
                            ?>
                            <div class="ui  tab <?php if ($num2 == 0) { ?>active<?php } ?>"
                                 data-tab="<?php echo str_replace('\\', '_', $namespace) . $key; ?>">
                                <table
