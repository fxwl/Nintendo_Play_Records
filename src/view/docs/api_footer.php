            ...
            <div class="ten wide column centered">
                ...
                <div class="column" align="center">
                    <p>
                        ...
                        <br/>
                        © 2015-<?php echo date('Y'); ?> Powered By <a href="http://www.phalapi.net/"
                                                                      target=""><?php echo \PhalApi\T('PhalApi API Framework'), ' ', PHALAPI_VERSION; ?> </a>
                        <span id="version_update"></span>
                        &nbsp;&nbsp;
                        <a target="_blank" href="http://pro.phalapi.net/" class="orange"><span
                                    class="ui tiny label orange"><i
                                        class="icon arrow alternate circle up"></i>专业版<span></a>
                    </p>
                </div>
            </div>
        </div>
