...
<div class="ui text container" style="max-width: none !important;">
    <div class="ui floating message">
        ...
        <h4><i class="linkify in alternate icon"></i><?php echo \PhalApi\T('API Url'); ?>：<?php echo $url; ?>
            ?s=<?php echo $service; ?></h4>
        ...
        <table class="ui red celled striped table">
            <thead>
            <tr>
                <th><?php echo \PhalApi\T('Parameter Name'); ?></th>
                <th><?php echo \PhalApi\T('Type'); ?></th>
                <th><?php echo \PhalApi\T('Is Required'); ?></th>
                <th><?php echo \PhalApi\T('Default'); ?></th>
                <th><?php echo \PhalApi\T('Note'); ?></th>
                <th><?php echo \PhalApi\T('Description'); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
...
EOT;
            ...
            <table class="ui red celled striped table">
                <thead>
                <tr>
                    <th width="25%"><?php echo \PhalApi\T('Parameter'); ?></th>
                    <th width="10%"><?php echo \PhalApi\T('Is Required'); ?></th>
                    <th width="65%"><?php echo \PhalApi\T('Value'); ?></th>
                </tr>
                </thead>
                <tbody id="params">
                <tr>
                    ...
                    <td>
                        <div class="ui fluid input disabled"><input name="service" data-source="get"
                                                                    value="<?php echo $service; ?>" style="width:100%;"
                                                                    class="C_input" id="service"/></div>
                    </td>
                </tr>
                <?php
                foreach ($rules as $key => $rule) {
...
EOT;
            ...
            <div class="ui fluid action input">
                ...
                <button class="ui button <?php echo !empty($methods) && strtoupper($methods) == 'POST' ? 'green' : 'blue'; ?>"
                        id="submit"><?php echo \PhalApi\T('Request API'); ?></button>
            </div>
