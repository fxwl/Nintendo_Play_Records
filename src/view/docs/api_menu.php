<div class="ui fixed inverted menu blue">
    <div class="ui container">
        ...
        <a href="http://docs.phalapi.net/#/v2.0/" class="item"><i
                    class="file alternate outline icon"></i> <?php echo \PhalApi\T('Docs'); ?></a>
        ...
        <div class="item">
            <div class="ui form">
                <form action="/docs.php?search=k" method="get" target="_blank">
                    <input type="text" name="keyword" placeholder="<?php echo \PhalApi\T('Search API'); ?>"
        ...
        <?php if (\PhalApi\DI()->admin->check(false)) { ?>
            <a class="item" target="_blank" href="/portal"><?php echo \PhalApi\T('welcome'); ?>
                : <?php echo \PhalApi\DI()->admin->username; ?></a>
        <?php } else { ?>

            <div class="item">
                <div class="ui green button"><a style="color:#fff;" href="/portal" target="_blank"><i
                                class="user icon"></i><?php echo \PhalApi\T('Sign In'); ?></a></div>
            </div>
        <?php } ?>
    </div>
</div>
